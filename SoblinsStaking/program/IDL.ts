export type NftStaking = {
  ...
  instructions: [
    ...
    {
      name: 'stakeNft';
      docs: ['* User can stake NFTs from specific collection'];
      accounts: [
        {
          name: 'user';
          isMut: true;
    ...
    {
      name: 'unstakeNft';
      docs: ['* User can unstake NFTs when they want'];
      accounts: [
        {
          name: 'user';
          isMut: true;
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          isMut: true;
          isSigner: false;
          docs: ['CHECK instruction will fail if wrong metadata is supplied'];
        },
        {
          name: 'authRules';
          isMut: false;
  ...
  accounts: [
    {
      name: 'globalPool';
      docs: ['* Global pool stores admin address'];
      type: {
        kind: 'struct';
        fields: [
          {
    ...
    {
      name: 'userPool';
      docs: ["* User pool stores user's stake data"];
      type: {
        kind: 'struct';
        fields: [
          {
